...
public class ApiFidelity extends AsyncTask<String, Void, String> {
    private User user;
    private Fidelity fidelity;

    public ApiFidelity(User user) {
        this.user = user;
    }
    ...
    protected String doInBackground(String... strings) {
        try {
            String link = "https://drivncook.fr/assets/api/apiAuth/user/myFidelity.php";
